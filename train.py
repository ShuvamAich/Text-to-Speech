...
if __name__ == "__main__":
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        plt.figure()
        plt.plot(epochs, dur_losses, label='Duration Loss')
        plt.plot(epochs, prior_losses, label='Prior Loss')
        plt.plot(epochs, diff_losses, label='Diffusion Loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.title('Loss Over Epochs')
        plt.legend()
        plt.savefig(f'{log_dir}/loss_epoch_{epoch}.png')
        plt.close()
